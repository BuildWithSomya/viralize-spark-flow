      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="text-xl font-bold">Viralyze</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              Transform any content into viral social media posts with AI. Automate your LinkedIn and Instagram success.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><Link to="/content" className="hover:text-white transition-colors">Content Manager</Link></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 Viralyze. All rights reserved.
          </p>
